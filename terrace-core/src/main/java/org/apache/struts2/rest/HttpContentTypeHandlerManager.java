 ...
 */
public class HttpContentTypeHandlerManager extends DefaultContentTypeHandlerManager {
	@Override
	public ContentTypeHandler getHandlerForRequest(HttpServletRequest request) {
		...
		return httpHeaderContentTypeHandler != null ? httpHeaderContentTypeHandler : super.getHandlerForRequest(request);
	}

	@Override
	public ContentTypeHandler getHandlerForResponse(HttpServletRequest request,HttpServletResponse response) {
		ContentTypeHandler httpHeaderContentTypeHandler = getHandlerByHttpHeader(request);
		return httpHeaderContentTypeHandler != null ? httpHeaderContentTypeHandler : super.getHandlerForResponse(request, response);
	}
