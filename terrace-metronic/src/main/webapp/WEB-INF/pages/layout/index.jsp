...
<head>
	...
	<title>Terrace | Admin Dashboard</title>
	...
	<link href="${base}/resources/plugins/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css"/>
	...
	<link href="${base}/resources/plugins/jquery.gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
	<link href="${base}/resources/plugins/bootstrap-datepicker/css/datepicker.css" rel="stylesheet" type="text/css"/>
	<link href="${base}/resources/plugins/bootstrap-timepicker/compiled/timepicker.css" rel="stylesheet" type="text/css"/>

	<link href="${base}/resources/plugins/fullcalendar/css/fullcalendar.css" rel="stylesheet" type="text/css"/>

	<link href="${base}/resources/plugins/jquery.vmap/css/jqvmap.css" rel="stylesheet" type="text/css" media="screen"/>

	<link href="${base}/resources/plugins/jquery.easy-pie-chart/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
...
<body class="page-header-fixed">
	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<img src="${base}/resources/image/logo.png" alt="logo"/>
				...
				<img src="${base}/resources/image/menu-toggler.png" alt="" />
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown" id="header_inbox_bar">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								...
								<span class="photo"><img src="${base}/resources/image/avatar2.jpg" alt="" /></span>
							...
							<li>
								...
								<span class="photo"><img src="./${base}/resources/image/avatar3.jpg" alt="" /></span>
							...
							<li>
								...
								<span class="photo"><img src="./${base}/resources/image/avatar1.jpg" alt="" /></span>
					...
					<li class="dropdown user">
						...
						<img alt="" src="${base}/resources/image/avatar1_small.jpg" />
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									...
									<div id="site_statistics_loading">
										...
										<img src="${base}/resources/image/loading.gif" alt="loading" />
												...
												<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
													...
													<div class="row-fluid">
														...
														<div class="span6 user-info">
															...
															<img alt="" src="${base}/resources/image/avatar.png" />
									...
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										...
										<ul class="chats">
											...
											<li class="in">
												...
												<img class="avatar" alt="" src="${base}/resources/image/avatar1.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="${base}/resources/image/avatar2.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="${base}/resources/image/avatar3.jpg" />
	...
	<script src="${base}/resources/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js" type="text/javascript"></script>
	...
	<script src="${base}/resources/plugins/jquery.vmap/jquery.vmap.js" type="text/javascript"></script>   

	<script src="${base}/resources/plugins/jquery.vmap/jquery.vmap.russia.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/jquery.vmap/jquery.vmap.world.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/jquery.vmap/jquery.vmap.europe.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/jquery.vmap/jquery.vmap.germany.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/jquery.vmap/jquery.vmap.usa.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/jquery.vmap/jquery.vmap.sampledata.js" type="text/javascript"></script>  

	<script src="${base}/resources/plugins/flot/jquery.flot.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/flot/jquery.flot.resize.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/others/jquery.pulsate.min.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/others/date.js" type="text/javascript"></script>
	
	<script src="${base}/resources/plugins/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/jquery.gritter/jquery.gritter.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/jquery.easy-pie-chart/jquery.easy-pie-chart.js" type="text/javascript"></script>

	<script src="${base}/resources/plugins/others/jquery.sparkline.min.js" type="text/javascript"></script>  
	...
	<script src="${base}/resources/plugins/others/index.js" type="text/javascript"></script>        
