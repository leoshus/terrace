...
<head>
	...
	<title>Terrace | Login Page</title>
	...
	<link href="${base }/resources/plugins/front-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>

	<link href="${base }/resources/css/style-metro.css" rel="stylesheet" type="text/css"/>
	...
	<link href="${base }/resources/css/default.css" rel="stylesheet" type="text/css" id="style_color"/>

	<link href="${base }/resources/css/uniform.default.css" rel="stylesheet" type="text/css"/>

	<!-- END GLOBAL MANDATORY STYLES -->

	<!-- BEGIN PAGE LEVEL STYLES -->

	<link href="${base }/resources/css/login/login.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	...
	<div class="logo">
		...
		<img src="${base }/resources/image/login/logo-big.png" alt="" /> 
	...
	<script src="${base }/resources/plugins/jquery/jquery-1.10.1.min.js" type="text/javascript"></script>
	...
	<script src="${base }/resources/plugins/jquery-ui/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>      
